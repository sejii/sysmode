 ...
 */
public class  U15_3 extends UAgent {

	/** 短期の節数のデフォルト値 */
	public static final int DEFAULT_SHORT_TERM = 1;

	/** 中期の節数のデフォルト値 */
	public static final int DEFAULT_MEDIUM_TERM = 3;
   ...
   * @param seed 乱数の種
   */
	 public U15_3(String loginName, String passwd, String realName, int seed) {
